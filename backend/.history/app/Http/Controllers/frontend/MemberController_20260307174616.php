...
class MemberController extends Controller
{
    ...
    {
        $members = Member::orderBy('created_at', 'desc')->where('status', 1)->limit($request->limit ?? 4)->get();
    ...
    public function index()   // Method to return a all list of active members for frontend in the Members page.
    {
