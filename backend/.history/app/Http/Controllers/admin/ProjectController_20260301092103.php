...
class ProjectController extends Controller
{
    ...
    // UPDATE PROJECT API.
    public function update(Request $request, $id)   // This method is used to update an existing project.
    {
    ...
    public function show($id)       // This method is used to fetch details of a single project.
    {
        $project = Project::find($id);
        if (!$project) {
            return response()->json([
    ...
    public function destroy($id)   // This method is used to delete a project.
    {
        $project = Project::find($id);
        if (!$project) {
            return response()->json([
