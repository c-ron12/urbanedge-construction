...
const ServiceDetail = () => {
  ...
  const sectionRef = React.useRef(null); // To scroll to top when user clicks on Read More Button of ServiceCard, linked with state defined in SerciceCard Read More button and in footer Link state
