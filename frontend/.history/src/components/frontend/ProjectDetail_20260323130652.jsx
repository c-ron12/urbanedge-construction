                ...
                <div className="card shadow border-0 sidebar-card mt-4">
                  <div className="card-body px-4 py-4">
                    ...
                    <ul className="list-unstyled">
                      {project.location && (
                        <li className="mb-2">
                          <span className="text-body-secondary" style ={{ textTransform: 'capitalize', color: '#000' }}>
                            Location
                            <p className="text-body-secondary">{project.location}</p>
                          </span>
                        </li>
                      )}
                      ...
                      {project.construction_type && (
                        <li className="mb-2">
                          <span className="text-body-secondary" style ={{ textTransform: 'capitalize', color: '#000' }}>
                            Construction Type
                            <p className="text-body-secondary">{project.construction_type}</p>
                          </span>
                        </li>
                      )}
                      ...
                      {project.sector && (
                        <li className="mb-2">
                          <span className="text-body-secondary" style ={{ textTransform: 'capitalize', color: '#000' }}>
                            Sector
                            <p className="text-body-secondary">{project.sector}</p>
                          </span>
                        </li>
                      )}
                    </ul>
