...
const Edit = () => {
  ...
  const {
    ...
    defaultValues: async () => {       // to set default filled values in form fields by fetching data from backend api.
      ...
      return {
        title: result.data.testimonial,
        slug: result.data.citation,
        short_desc: result.data.designation,
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-3">
                      ...
                      <JoditEditor
                        key={testimonial.id} // Important for re-rendering with fetched data.
                        ref={editor}
                        value={content}
                        config={config}
                        tabIndex={1}
