              ...
              <div className="card shadow border-0">
                <div className="card-body">
                  ...
                  <table className="table table-striped">
                    ...
                    <tbody>
                      {articles &&
                        articles.map((articleBlogs) => (
                          <tr key={articleBlogs.id}>
                            <td>{articleBlogs.id}</td>
                            <td>{articleBlogs.title}</td>
                            {/* <td>{article.slug}</td> */}
                            ...
                            <td>
                              <Link
                                to={`/admin/articles-blogs/edit/${articleBlogs.id}`}
                                className="btn btn-sm btn-info me-2"
                              >
                                Edit
                              </Link>
                              <Link
                                onClick={() => deletearticle(articleBlogs.id)}
                                href="#"
