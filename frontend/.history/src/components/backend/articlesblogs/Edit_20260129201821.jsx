...
const Edit = ({ placeholder = 'content' }) => {
  ...
  const {
    ...
    defaultValues: async () => {
      ...
      setArticlesBlogs(result.data); // to store fetched article data in state, data is coming from backend api articleController@show.
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-3">
                      ...
                      <JoditEditor
                        key={articlesBlogs.id} // Important for re-rendering with fetched data.
                        ref={editor}
                        value={content}
                        config={config}
                        tabIndex={1}
