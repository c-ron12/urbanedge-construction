...
const Create = ({ placeholder = 'content' }) => {
  ...
  const [imageId, setImageId] = React.useState(null); // to store uploaded image.
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="row mb-3">
                      <div className="col-md-6">
                        ...
                        <select {...register('sector')} className="form-select">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        type="file"
                        onChange={handleFile} // Upload starts background processing immediately.
                        className="form-control"
                      />
                    </div>
