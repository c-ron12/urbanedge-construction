        ...
        <div className="item ">
          ...
          <div className="service-body">
            ...
            <NavLink
              ...
              state={{ from: 'sidebar' }} // This state is used in ServiceDetail.jsx to determine if the user came from an external page (like LatestServices) or from the sidebar within ServiceDetail. If it's 'external', we scroll to top when they click on Read More Button of ServiceCard. If it's from sidebar of ServiceDetail page, we don't scroll to top because they are already on the service detail page.
