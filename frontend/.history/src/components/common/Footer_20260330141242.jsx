        ...
        <div className="row">
          ...
          <div className="col-md-3 mt-4 mt-md-0 ps-md-5">
            ...
            <ul className="list-unstyled">
              <li>
                <NavLink to="/service/20">Custom Home Construction</NavLink>
              </li>
              <li>
                <NavLink to="/service/17">Renovation and Remodeling</NavLink>
              </li>
              <li>
                <NavLink to="/service/18">Commercial Constructions</NavLink>
              </li>
              <li>
                <NavLink to="/service/19">Sustainable Building Solution</NavLink>
              </li>
            </ul>
          </div>
