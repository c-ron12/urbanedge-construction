...
const Articles = () => {
  ...
  const fetchArticles = async () => {
    ...
    // console.log(result);
    setArticles(result.data); // data is coming from backend api response latestBlogs function of frontend/BlogsController.
  };
          ...
          <div className="row pt-5">
            {Articles &&
              Articles.map((articles) => {
                return (
                  <div key={articles.id} className="col-lg-3 col-sm-6 pb-5">
                    <div className="item">
                      <div className="service-image">
                        <img
                          src={`${fileUrl}/uploads/projects/small/${articles.image}`}
                          className="w-100"
