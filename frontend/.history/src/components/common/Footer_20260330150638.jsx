        ...
        <div className="row">
          ...
          <div className="col-md-3 mt-4 mt-md-0 ps-md-5">
            ...
            <ul className="list-unstyled">
              <li>
                <Link to="/service/20" state={{ from: 'footer' }}>     // using state to Identify footer navigation ServiceDetail scrolls to the sidebar section instead of top
                  Custom Home Construction
                </Link>
              </li>
              <li>
                <Link to="/service/17" state={{ from: 'footer' }}>
                  Renovation and Remodeling
                </Link>
                // using state to Identify footer navigation ServiceDetail scrolls to the sidebar section instead of top
              </li>
              <li>
                <Link to="/service/18" state={{ from: 'footer' }}>
                  Commercial Constructions
                </Link>
              </li>
              <li>
                <Link to="/service/19" state={{ from: 'footer' }}>
